...
class StoreInfo(TimestampMixin, db.Model):
    ...
    fssai_number = db.Column(db.String(20), nullable=True, unique=True)
    email = db.Column(db.String(100), nullable=True)
    logo = db.Column(db.String(255), nullable=True)

    __table_args__ = (
        db.CheckConstraint('length(phone_number) >= 10 OR phone_number IS NULL', name='check_phone_number_length'),
        db.CheckConstraint('length(gst_number) >= 15 OR gst_number IS NULL', name='check_gst_number_length'),
        db.CheckConstraint('length(fssai_number) >= 14 OR fssai_number IS NULL', name='check_fssai_number_length'),
    )
...
class StickerDesign(TimestampMixin, db.Model):
    ...
    store_logo_position = db.Column(db.JSON, nullable=False, default={"top": 5.0, "left": 5.0, "max_width": 20.0, "font_size": 8.0})
    store_name_position = db.Column(db.JSON, nullable=False, default={"top": 5.0, "left": 30.0, "max_width": 40.0, "font_size": 8.0})
    store_address_position = db.Column(db.JSON, nullable=False, default={"top": 10.0, "left": 30.0, "max_width": 40.0, "font_size": 6.0})
    store_phone_position = db.Column(db.JSON, nullable=False, default={"top": 15.0, "left": 30.0, "max_width": 40.0, "font_size": 6.0})
    store_gst_position = db.Column(db.JSON, nullable=False, default={"top": 20.0, "left": 30.0, "max_width": 40.0, "font_size": 6.0})
    store_fssai_position = db.Column(db.JSON, nullable=False, default={"top": 25.0, "left": 30.0, "max_width": 40.0, "font_size": 6.0})
    store_email_position = db.Column(db.JSON, nullable=False, default={"top": 30.0, "left": 30.0, "max_width": 40.0, "font_size": 6.0})
    product_name_position = db.Column(db.JSON, nullable=False, default={"top": 43.0, "left": 36.0, "max_width": 30.0, "font_size": 8.0})
    mrp_position = db.Column(db.JSON, nullable=False, default={"top": 47.0, "left": 36.0, "max_width": 30.0, "font_size": 6.0})
    net_weight_position = db.Column(db.JSON, nullable=False, default={"top": 49.5, "left": 36.0, "max_width": 30.0, "font_size": 6.0})
    mfg_date_position = db.Column(db.JSON, nullable=False, default={"top": 52.0, "left": 36.0, "max_width": 30.0, "font_size": 6.0})
    exp_date_position = db.Column(db.JSON, nullable=False, default={"top": 54.5, "left": 36.0, "max_width": 30.0, "font_size": 6.0})
    batch_no_position = db.Column(db.JSON, nullable=False, default={"top": 57.0, "left": 36.0, "max_width": 30.0, "font_size": 6.0})
    ingredients_position = db.Column(db.JSON, nullable=False, default={"top": 68.0, "left": 36.0, "max_width": 40.0, "font_size": 6.0})
    nutritional_facts_position = db.Column(db.JSON, nullable=False, default={"top": 50.0, "left": 8.0, "max_width": 30.0, "font_size": 6.0})
    allergen_info_position = db.Column(db.JSON, nullable=False, default={"top": 74.0, "left": 8.0, "max_width": 30.0, "font_size": 6.0})
    ...
    print_store_logo = db.Column(db.Boolean, default=True)
    print_store_name = db.Column(db.Boolean, default=True)
    print_store_address = db.Column(db.Boolean, default=True)
    print_store_phone = db.Column(db.Boolean, default=True)
    print_store_gst = db.Column(db.Boolean, default=True)
    print_store_fssai = db.Column(db.Boolean, default=True)
    print_store_email = db.Column(db.Boolean, default=True)
